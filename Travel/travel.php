            ...
            <div class="row">
                ...
                <?php 			
                     ...
                     foreach ($images as $img){
                         echo "<div class='col-md-3'><a href='travel-image.php?id=$img[id]' class='thumbnail'>
                         <img src='images/travel/medium/$img[path]' alt='...'></a>
                         </div>";
                     }
			    ?> 
                <!--<div class="col-md-3"><a href="travel-image.php?id=..." class ="thumbnail"><img src = images/travel/medium/..." alt =""></a></div>-->
